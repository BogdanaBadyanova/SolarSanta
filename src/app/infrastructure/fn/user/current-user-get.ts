...
export function currentUserGet(http: HttpClient, rootUrl: string, params?: CurrentUserGet$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiCurrentUser>> {
